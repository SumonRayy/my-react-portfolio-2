          ...
          <aside id="colorlib-aside" className="border js-fullheight">
            <div className="text-center">
              <div
                ...
                style={{
                  backgroundImage: "url(https://i.imgur.com/sjBnQ0S.png)",
                }}
              />
              <h1 id="colorlib-logo">
                <a href="index.html">Sumon Roy</a>
              </h1>
              <span className="email">
                <i className="icon-mail"></i> sumonrayy@gmail.com
              </span>
            </div>
            ...
            <nav id="colorlib-main-menu">
              <ul>
                <li>
                  <a
                    href="https://www.facebook.com/sumon.roy.9889"
                    target="_blank"
                ...
                <li>
                  <a
                    href="https://twitter.com/SumonRayy"
                    target="_blank"
                    rel="noopener noreferrer"
                  >
                ...
                <li>
                  <a
                    href="https://www.instagram.com/sumonrayy/"
                    target="_blank"
                    rel="noopener noreferrer"
                  >
                ...
                <li>
                  <a
                    href="https://www.linkedin.com/in/sumon-roy-29a2b3186/"
                    target="_blank"
                    rel="noopener noreferrer"
                  >
